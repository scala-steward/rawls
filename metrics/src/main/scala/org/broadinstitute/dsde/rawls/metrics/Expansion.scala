...
object Expansion {
  ...
  /**
    * Implicit expansion for a spray HttpMethod.
    */
  ...
  /**
    * Implicit expansion for a spray Uri.
    * Uses the URI path, replacing any slashes with periods.
    */
  ...
  /**
    * Implicit expansion for a spray StatusCode.
    */
