...
object Dependencies {
  ...
  val googleRpc: ModuleID =               "io.grpc" % "grpc-core" % "1.36.0"
  ...
  val scalaCache: ModuleID =      "com.github.cb372"              %% "scalacache-caffeine"  % "0.28.0"
  val apacheCommonsIO: ModuleID = "commons-io"                    % "commons-io"            % "2.8.0"
